...
def load_imagenet(data_path, data_shares, alpha, n_large):
...
def get_datasets(dataroot, val_size=10000):
    """
    get_datasets returns train/val/test data splits of ImageNet dataset
    :param data_name: name of dataset, should be 'imagenet'
    ...
    test_dir = os.path.join(dataroot, 'val')
